...
rmse_dif = xr.open_dataset('../output/rmse_dif_laf_'+model+'.nc')
rmse_difcor = xr.open_dataset('../output/rmse_difcor_laf_'+model+'.nc')
kge_delta = xr.open_dataset('../output/kge_dif_laf_'+model + '.nc')
kge_deltacor = xr.open_dataset('../output/kge_difcor_laf_'+model + '.nc')
...
cb = mpl.colorbar.ColorbarBase(ax=cbax,cmap=cmap,
                           ...
                           extend='both')
cb.ax.set_title('\u0394RMSE = $RMSE_{weighted}$ - $RMSE_{laf}$', fontsize=9)
...
cb1 = mpl.colorbar.ColorbarBase(ax=cbax2,cmap=cmap2,
                           ...
                           orientation='horizontal',
                           extend='both')
cb1.ax.set_title('\u0394KGE = $KGE_{weighted}$ - $KGE_{laf}$', fontsize=9)
...
plt.savefig('../plot1/global/metrics_diflaf_cor_'+model+'.png')

lon_seas = []
rmse_difcor_seas = xr.open_dataset('../output/rmse_difcor_laf_seas_'+model+'.nc')
rmse_difcor_seas = rmse_difcor_seas.reindex(lat=list(reversed(rmse_difcor_seas.lat)))

kge_difcor_seas = xr.open_dataset('../output/kge_difcor_laf_seas_'+model+'.nc')
...
cb = mpl.colorbar.ColorbarBase(ax=cbax,cmap=cmap,
                           ...
                           orientation='horizontal',
                           extend='both')
cb.ax.set_title('\u0394RMSE  = $RMSE_{weighted}$ - $RMSE_{laf}$')
cb.ax.set_xticklabels(tick_labels1)
cb.ax.tick_params(labelsize=7)
#plot arrows
...
plt.savefig('../plot1/global/rmse_diflaf_cor_season_'+model+'.png') 
...
cb1 = mpl.colorbar.ColorbarBase(ax=cbax2,cmap=cmap2,
                           ...
                           orientation='horizontal',
                           extend='both')
cb1.ax.set_title('\u0394KGE  = $KGE_{weighted}$ - $KGE_{laf}$')
cb1.ax.set_xticklabels(tick_labels2)
cb1.ax.tick_params(labelsize=7)
#plot arrows
bluelabel1 = 'Higher efficiency/Higher Skill'
...
plt.savefig('../plot1/global/kge_diflaf_cor_season_'+model+'.png') 

rmse_umpd = xr.open_dataset('../output/rmse_umpd_laf_'+model+'.nc')
rmse_mpd= xr.open_dataset('../output/rmse_mpd_global_'+model+'.nc')
rmse_umpdcor= xr.open_dataset('../output/rmse_umpdcor_laf_'+model+'.nc')
rmse_mpdcor= xr.open_dataset('../output/rmse_mpdcor_global_'+model+'.nc')

kge_umpd= xr.open_dataset('../output/kge_umpd_laf_'+model + '.nc')
kge_mpd= xr.open_dataset('../output/kge_mpd_global_'+model + '.nc')
kge_umpdcor= xr.open_dataset('../output/kge_umpd_laf_'+model + '.nc')
kge_mpdcor= xr.open_dataset('../output/kge_mpd_global_'+model + '.nc')
...
ax1.set_xlabel('\u0394RMSE = $RMSE_{weighted}$ - $RMSE_{laf}$')
...
ax2.set_xticklabels(['lafmpd', 'wgdmpd', 'lafmpdcor', 'wgdmpdcor'])
ax2.set_ylabel('RMSE')
ax2.set_title("RMSE box plot")
ax2.set_title('b.',fontweight = 'bold', loc='left')
plt.savefig('../plot1/global/rmse_laf_lonbp_'+model+'.png')

#zonal mean plots with box plot KGE
fig= plt.figure(figsize =(10, 7))
ax1 = fig.add_subplot(121)
ax1.set_xlabel('\u0394KGE = $KGE_{weighted}$ - $KGE_{laf}$')
ax1.set_ylabel('lattitude [\u00b0]')
...
ax2.set_title('b.',fontweight = 'bold', loc='left')
plt.savefig('../plot1/global/kge_laf_lonbp_'+model+'.png')
...
ax.set_xlabel('\u0394RMSE = $RMSE_{weighted}$ - $RMSE_{laf}$', labelpad = 35)
...
plt.savefig('../plot1/global/rmse_laf_lon_season_'+model+'.png')
...
ax.set_xlabel('\u0394KGE = $KGE_{weighted}$ - $KGE_{laf}$',labelpad = 35)
ax.set_ylabel('lattitude [\u00b0]', labelpad = 35)
ax.spines['top'].set_visible(False)
ax.spines['right'].set_visible(False)
ax.spines['left'].set_visible(False)
...
plt.savefig('../plot1/global/kge_laf_lon_season_'+model+'.png')
